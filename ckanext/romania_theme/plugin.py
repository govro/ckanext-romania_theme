...
class Romania_ThemePlugin(plugins.SingletonPlugin):
    ...
    def before_create(self, context, resource):
        if resource.get('upload') and resource['upload'].type in ['application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/msword']:
